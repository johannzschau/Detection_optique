...
char Expander_Read_Byte(char ModuleAddress, char RegAddress){
  ...
  I2C2_Start();
  I2C2_Write(AddressCode|ModuleAddress,reg_data,1,END_MODE_RESTART);
  I2C2_Read(AddressCode|ModuleAddress,reg_data,1,END_MODE_STOP);
...
void Expander_Write_Byte(char ModuleAddress,char RegAddress, char Data_) {
  ...
  I2C2_Start();
  I2C2_Write(AddressCode|ModuleAddress,reg_data,2,END_MODE_STOP);
}